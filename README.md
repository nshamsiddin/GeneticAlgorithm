...
- Singleton
  - Singleton class is defined for factory method providers. It is the simplest version of Singleton - eager initialization. It is thread-safe although it might be less effective in some cases due to the initialization at runtime - whether the method is needed or not. For current project this implementation is feasible since mutation and selection are main operations and the program starts using them from the start.
